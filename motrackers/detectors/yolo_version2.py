...
from motrackers.utils.misc import check_if_detection_in_ROI_v2


class YOLO_v2(Detector):
    """
    ...
    def detect(self, image,corners):
        ...
        indices = cv.dnn.NMSBoxes(bboxes, confidences, self.confidence_threshold, self.nms_threshold)

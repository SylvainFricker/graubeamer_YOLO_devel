...
from motrackers import CentroidTracker, CentroidKF_Tracker, SORT, IOUTracker, kalman_tracker
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--video', '-v', type=str, default="./../video_data/ilanz_short_1_2fps.mp4", help='Input video path.')
